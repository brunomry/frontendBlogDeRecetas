    ...
    <section className="container mainSection">
      ...
      <Form className="my-4 sizeForm mx-auto" onSubmit={handleSubmit(recetaValidada)}>
        ...
        <Form.Group className="mb-3 " controlId="formDescripcionBreve">
          <Form.Label className="fw-medium">
            Descripción breve <span className={`text-danger fw-bold ${ocultar ? "d-none" : ""}`}>*</span>
          </Form.Label>
          <Form.Control
            className="textarea"
            type="text"
        ...
        <Form.Group className="mb-3 " controlId="formDescripcionAmplia">
          <Form.Label className="fw-medium">
            Descripcion amplia <span className={`text-danger fw-bold ${ocultar ? "d-none" : ""}`}>*</span>
          </Form.Label>
          <Form.Control
        ...
        <Form.Group className="mb-3 " controlId="formIngredientes">
          <Form.Label className="fw-medium">
            Ingredientes <span className={`text-danger fw-bold ${ocultar ? "d-none" : ""}`}>*</span>
          </Form.Label>
          <Form.Control
            className="textarea"
            type="text"
        ...
        <Form.Group className="mb-3 " controlId="formPreparacion">
          <Form.Label className="fw-medium">
            Preparación <span className={`text-danger fw-bold ${ocultar ? "d-none" : ""}`}>*</span>
          </Form.Label>
          <Form.Control
        ...
        <div className="row">
          <Form.Group className="mb-3 col-md-6" controlId="formAutor">
            <Form.Label className="fw-medium">
              Autor <span className={`text-danger fw-bold ${ocultar ? "d-none" : ""}`}>*</span>
            </Form.Label>
            <Form.Control
              type="text"
              disabled={deshabilitado}
          ...
          <Form.Group className="mb-3 col-md-3" controlId="formFecha">
            <Form.Label className="fw-medium">
              Fecha <span className={`text-danger fw-bold ${ocultar ? "d-none" : ""}`}>*</span>
            </Form.Label>
            <Form.Control
              type="date"
              disabled={deshabilitado}
        ...
        <Form.Group className="mb-3 " controlId="formImagen">
          <Form.Label className="fw-medium">
            URL de imagen <span className={`text-danger fw-bold ${ocultar ? "d-none" : ""}`}>*</span>
          </Form.Label>
          <Form.Control
            type="url"
            disabled={deshabilitado}
        ...
        <Form.Group className="mb-3 ">
          <Button
            type="submit"
            variant="success"
            className={`m-2 ${ocultar ? "d-none" : "btnForm"}`}
            disabled={deshabilitado}
          >
            Guardar
          </Button>
          <Link
            className={`m-2 btn ${verDetalle ? "btn-secondary" : "btn-danger"}`}
            to={"/administrador"}
          >
            {boton}
          </Link>
